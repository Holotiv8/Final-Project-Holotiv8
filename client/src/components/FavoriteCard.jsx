	...
	return (
		...
		>
			<div className=' flex justify-end pr-2 gap-2 z-40 pt-2  '>
				...
				<a href="#" className='flex w-max  cursor-pointer'
                    onClick={e => {
			...
			/>
			<div className={` hover:bg-opacity-80 -bottom-52  z-40 absolute group-hover:bottom-2 right-2 left-2 transition-all duration-500  opacity-80 dark:bg-pink-200 p-4 rounded shadow dark:shadow-red-100 cursor-default`}>
				<div className="text-4xl font-extrabold" >{favorites.name}</div>
				<div className="font-normal text-sm text-justify">
					Hallo {favorites.fanName}, thanks for let me in your favorites
					talent
				</div>
			</div>
